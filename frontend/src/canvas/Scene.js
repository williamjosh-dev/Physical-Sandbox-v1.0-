...
export default function Scene({ trajectory, currentFrame, isPlaying, blueprint, onFrameAdvance }) {
    ...
    return (_jsx("div", { ref: containerRef, style: { width: '100%', height: '100%', position: 'absolute', inset: 0 }, children: _jsx(Spacecraft, { scene: threeScene, trajectory: trajectory, currentFrame: currentFrame, blueprint: blueprint }) }));
}
