...
export default function Scene({ trajectory, currentFrame, isPlaying, onFrameAdvance }: SceneProps) {
  ...
  useEffect(() => {
    ...
    const ambientLight = new THREE.AmbientLight(0xffffff, 0.8); // Slightly increased for visibility
    scene.add(ambientLight);

    const sunLight = new THREE.DirectionalLight(0xffffff, 1.5); // Boosted sun brightness
