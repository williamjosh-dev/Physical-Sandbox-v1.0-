...
export default function Sidebar({ onTriggerSimulation, statusText }) {
    ...
    return (_jsxs("div", { style: {
        ...
        }, children: [_jsx("h3", { style: { margin: '0 0 15px 0', borderBottom: '1px solid #00ffcc', paddingBottom: '5px' }, children: "\uD83E\uDDE0 AI SIMULATION PROMPT" }), _jsxs("form", { onSubmit: handleSubmit, children: [_jsx("textarea", { value: inputValue, onChange: (e) => setInputValue(e.target.value), placeholder: "e.g., Simulate rocket flight with 50000kg mass and 760000N thrust...", style: {
                            width: '100%',
                            height: '100px',
